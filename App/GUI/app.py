...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(0, 0, 281, 401))
        ...
        for address in range(31):
            self.addressComboBox.addItem(f"{address}")
    ...
    def addButtonClicked(self):
        self.verticalLayout.addWidget(Instrument())
